package com.example.hammer.test;
...
//        Log.d("","");
        ...
        etFirstValue = (EditText) findViewById(R.id.et_main_first_value);
        etSecondValue = (EditText) findViewById(R.id.et_main_second_value);
