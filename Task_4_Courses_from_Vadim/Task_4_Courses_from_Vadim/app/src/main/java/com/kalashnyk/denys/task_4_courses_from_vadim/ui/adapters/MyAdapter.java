...
public class MyAdapter extends RecyclerView.Adapter<ViewHolderPerson> {
    ...
    @Override
    public void onBindViewHolder(final ViewHolderPerson holder, final int position) {
        final Person person = (Person) mList.get(position);
...
//                view.getContext().startActivity(intent);
    ...
    public void dismissPerson(int position) {
        ...
        Person person = (Person) mList.get(position);
        if(!mList.isEmpty()) {
            mList.remove(position);
            crudSharedPreferences.removePerson(this.mContext,person);
        }
