package com.kalashnyk.denys.task_9_courses_from_vadim.ui.adapters;
...
import com.kalashnyk.denys.task_9_courses_from_vadim.ui.activites.DetailsPersonsActivity;
import com.kalashnyk.denys.task_9_courses_from_vadim.ui.activites.MainActivity;
...
//
//        TextView tvNamePerson = (TextView) view.findViewById(R.id.text_view_item_short_name);
//        TextView tvPhoneNumberPerson = (TextView) view.findViewById(R.id.text_view_item_short_phone_number);
//        ImageButton ibShortEdit = (ImageButton) view.findViewById(R.id.btn_short_edit);
...
//                personItem.setmSkype(etDialogSkype.getText().toString());
                crudsqLite.updatePerson(personItem.getId(), etDialogName.getText().toString(),
        ...
        alertDialogBuilder.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if (!persons.isEmpty()) {
                    ...
                    crudsqLite.deletePerson(personItem.getId());
                }
                notifyDataSetChanged();
            }
        });
