...
import com.kalashnyk.denys.task_9_courses_from_vadim.ui.adapters.MyAdapter;
...
//        crudsqLite = new CRUDSQLite(this);
    ...
    //        Person personModelIntent;
    //
    //        int strGetExtrasId = getMyIntent.getIntExtra("id", 0);
    //        String strGetExtrasName = getMyIntent.getStringExtra("name");
    //        String strGetExtrasSurname = getMyIntent.getStringExtra("surname");
    //        String strGetExtrasPhone = getMyIntent.getStringExtra("phone");
    //        String strGetExtrasMail = getMyIntent.getStringExtra("mail");
    //        String strGetExtrasSkype = getMyIntent.getStringExtra("skype");
    //        personModelIntent = new Person(strGetExtrasId, strGetExtrasName, strGetExtrasSurname,
    //                strGetExtrasPhone, strGetExtrasMail, strGetExtrasSkype);
    //
    //        return personModelIntent;
    //    }
}
